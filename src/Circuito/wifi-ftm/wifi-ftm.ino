...
const char * WIFI_FTM_SSID = "ConexaoJoao"; // SSID of AP that has FTM Enabled
const char * WIFI_FTM_PASS = "joaolindao"; // STA Password
...
const uint16_t FTM_BURST_PERIOD = 15;
